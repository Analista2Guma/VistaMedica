...
public class vst_3m_cla_model {
    ...
    public static void Save(Context context, ArrayList<MvstCLA> ARTI){
        ...
        try
        {
            ...
            if (ARTI.size()>0){
                ...
                SQLiteHelper.ExecuteSQL(ManagerURI.getDirDb(), context,"DELETE FROM vst_m3_CLA");
                for(int i=0;i<ARTI.size();i++){
                    ...
                    myDataBase.insert("vst_m3_CLA", null, contentValues );
                }
            }
        }
        catch (Exception e) {
    ...
    public static List<MvstCLA>get(String basedir, Context context,String Cls) {
