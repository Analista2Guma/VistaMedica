...
public class LogActividades_model {
    ...
    public static List<Log_Actividades> get_aEnviar(String basedir, Context context) {
        List<Log_Actividades> lst = new ArrayList<>();
        SQLiteDatabase myDataBase = null;
        SQLiteHelper myDbHelper = null;
        ...
        try
        {
            myDbHelper = new SQLiteHelper(basedir, context);
            myDataBase = myDbHelper.getReadableDatabase();
            Cursor cursor = myDataBase.query(true, "log_actividades", null, "ESTADO"+ "=?", new String[] { "0" }, null, null, null, null);
            if(cursor.getCount() > 0) {
                cursor.moveToFirst();
                while(!cursor.isAfterLast()) {
                    Log_Actividades tmp = new Log_Actividades();
    ...
    public static List<Log_Actividades> get_commit(String basedir, Context context,String ID) {
        List<Log_Actividades> lst = new ArrayList<>();
        SQLiteDatabase myDataBase = null;
        SQLiteHelper myDbHelper = null;
        ...
        try
        {
            myDbHelper = new SQLiteHelper(basedir, context);
            myDataBase = myDbHelper.getReadableDatabase();
            Cursor cursor = myDataBase.query(true, "log_actividades", null, "IDRPT"+ "=?", new String[] { ID }, null, null, null, null);
            if(cursor.getCount() > 0) {
                cursor.moveToFirst();
                while(!cursor.isAfterLast()) {
                    Log_Actividades tmp = new Log_Actividades();
    ...
    public static List<DetalleLog> get_detalle_aEnviar(String basedir, Context context) {
        List<DetalleLog> lst = new ArrayList<>();
        SQLiteDatabase myDataBase = null;
        SQLiteHelper myDbHelper = null;
        try
        {
            myDbHelper = new SQLiteHelper(basedir, context);
            myDataBase = myDbHelper.getReadableDatabase();
            Cursor cursor = myDataBase.query(true, "log_actividades_detalle", null, "ESTADO"+ "=?", new String[] { "0" }, null, null, null, null);
            if(cursor.getCount() > 0) {
                cursor.moveToFirst();
    ...
    public static List<DetalleLog> get_row(String basedir, Context context,String ID) {
        List<DetalleLog> lst = new ArrayList<>();
        SQLiteDatabase myDataBase = null;
        SQLiteHelper myDbHelper = null;
        try
        {
            myDbHelper = new SQLiteHelper(basedir, context);
            myDataBase = myDbHelper.getReadableDatabase();
            Cursor cursor = myDataBase.query(true, "log_actividades_detalle", null, "IDRPT"+ "=?", new String[] { ID }, null, null, null, null);
            if(cursor.getCount() > 0) {
                cursor.moveToFirst();
